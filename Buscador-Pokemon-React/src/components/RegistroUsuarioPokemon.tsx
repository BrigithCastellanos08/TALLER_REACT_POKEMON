            ...
            <div>
                <form onSubmit={eventoSubmit}>
                    ...
                    <div className="grid">
                        ...
                        <div className="field">
                            <label htmlFor="tipo-documento">Tipo de documento <span className="req">*</span></label>
                            <select id="tipo_documento" value={tipoDocumento} onChange={(e) => setTipoDocumento(e.target.value)} name="tipoDocumento" className="select" required>
                        ...
                        <div className="field">
                            <label htmlFor="dni">documento <span className="req">*</span></label>
                            <input type="text"  id="documento" value={dni} onChange={(e) => setDni(e.target.value)} name="dni" className="input input--mono"
                        ...
                        <div className="field">
                            <label htmlFor="fecha_nacimiento">Fecha de nacimiento <span className="req">*</span></label>
                            <input type="date" id="fecha_nacimiento" value={fechaNacimiento} onChange={(e) => setFechaNacimiento(e.target.value)} name="fechaNacimiento" className="input" required />
